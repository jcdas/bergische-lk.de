...
const SITE = {
  ...
  tournaments: [
    ...
    {
      id: "esv-summer-smash-3",
      name: "LK Summer Smash Series - ESV - 3",
      venue: "esv-wuppertal",
      dates: { de: "07. Juni 2026 (Sonntag)", en: "June 7, 2026 (Sunday)" },
      categories: ["U12", "U14", "U16", "H00"],
      status: "upcoming",
      mybigpoint: "",
      nenngeld: {
    ...
    {
      id: "esv-summer-smash-4",
      name: "LK Summer Smash Series - ESV - 4",
      venue: "esv-wuppertal",
      dates: { de: "28. Juni 2026 (Sonntag)", en: "June 28, 2026 (Sunday)" },
      categories: ["U12", "U14", "U16", "H00"],
      status: "upcoming",
      mybigpoint: "",
      nenngeld: {
    ...
    {
      id: "esv-summer-smash-5",
      name: "LK Summer Smash Series - ESV - 5",
      venue: "esv-wuppertal",
      dates: { de: "05. Juli 2026 (Sonntag)", en: "July 5, 2026 (Sunday)" },
      categories: ["U12", "U14", "U16", "H00"],
      status: "upcoming",
      mybigpoint: "",
      nenngeld: {
    ...
    {
      id: "esv-summer-smash-6",
      name: "LK Summer Smash Series - ESV - 6",
      venue: "esv-wuppertal",
      dates: { de: "11. Juli 2026 (Samstag)", en: "July 11, 2026 (Saturday)" },
      categories: ["U12", "U14", "U16", "H00"],
      status: "upcoming",
      mybigpoint: "",
      nenngeld: {
